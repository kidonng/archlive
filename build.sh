...
iso_name=archlive
iso_label="ARCHLIVE"
iso_publisher="Kid <https://github.com/kidonng>"
iso_application="A better Arch Linux Live/Rescue CD"
...
make_basefs() {
    ...
    mkarchiso ${verbose} -w "${work_dir}/x86_64" -C "${work_dir}/pacman.conf" -D "${install_dir}" -p "haveged intel-ucode amd-ucode memtest86+ mkinitcpio-nfs-utils nbd fish efitools" install
}
...
make_customize_airootfs() {
    ...
    lynx -dump -nolist 'https://wiki.archlinux.org/index.php/Installation_Guide?action=render' >> ${work_dir}/x86_64/airootfs/etc/skel/Desktop/install.txt
...
make_efi() {
    ...
    curl -o ${work_dir}/iso/EFI/shellx64_v2.efi https://cdn.jsdelivr.net/gh/tianocore/edk2@UDK2018/ShellBinPkg/UefiShell/X64/Shell.efi
    # EFI Shell 1.0 for non UEFI 2.3+
    curl -o ${work_dir}/iso/EFI/shellx64_v1.efi https://cdn.jsdelivr.net/gh/tianocore/edk2@UDK2018/EdkShellBinPkg/FullShell/X64/Shell_Full.efi
}
